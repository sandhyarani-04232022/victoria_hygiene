...
if( !class_exists( 'Mezan_Woo_Listing_Shop' ) ) {

    class Mezan_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'mezan_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('mezan_woo_listing_shop') ) {
	function mezan_woo_listing_shop() {
		return Mezan_Woo_Listing_Shop::instance();
	}
}

mezan_woo_listing_shop();