...
if( !class_exists( 'Mezan_Woo_Listing_Option_Content_Element_Group' ) ) {

    class Mezan_Woo_Listing_Option_Content_Element_Group extends Mezan_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'mezan_woo_custom_product_template_content_options', array( $this, 'woo_custom_product_template_content_options'), 50, 1 );
        }
...
if( !function_exists('mezan_woo_listing_option_content_element_group') ) {
	function mezan_woo_listing_option_content_element_group() {
		return Mezan_Woo_Listing_Option_Content_Element_Group::instance();
	}
}

mezan_woo_listing_option_content_element_group();