...
if( !class_exists( 'Mezan_Woo_Listing_Tag' ) ) {

    class Mezan_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'mezan_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('mezan_woo_listing_tag') ) {
	function mezan_woo_listing_tag() {
		return Mezan_Woo_Listing_Tag::instance();
	}
}

mezan_woo_listing_tag();