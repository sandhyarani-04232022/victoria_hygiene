...
if( !class_exists( 'Mezan_Woo_Others' ) ) {

    class Mezan_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'mezan_woo_others_settings', $this->settings );
...
if( !function_exists('mezan_woo_others') ) {
	function mezan_woo_others() {
		return Mezan_Woo_Others::instance();
	}
}
