...
if( !class_exists( 'Mezan_Shop_Others_Quantity_Plus_Minus' ) ) {

    class Mezan_Shop_Others_Quantity_Plus_Minus {
        ...
        function __construct() {
            ...
            // JS
                add_action( 'mezan_after_woo_js', array ( $this, 'after_woo_js' ) );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_DIR . '/woocommerce/others/quantity-plus-minus/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_URI . '/woocommerce/others/quantity-plus-minus/';
                } else {
        ...
        */
            function after_woo_js() {
                ...
                if( !is_product() && !is_cart() ) {
                    ...
                    wp_register_script( 'mezan-woo-quantity-plus-minus', '', array ('jquery'), false, true );
                    wp_enqueue_script( 'mezan-woo-quantity-plus-minus' );
                    ...
                    if( !empty($js) ) {
                        wp_add_inline_script( 'mezan-woo-quantity-plus-minus', $js );
                    }
...
if( !function_exists('mezan_shop_others_quantity_plus_minus') ) {
	function mezan_shop_others_quantity_plus_minus() {
        $reflection = new ReflectionClass('Mezan_Shop_Others_Quantity_Plus_Minus');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Mezan_Shop_Others_Quantity_Plus_Minus::instance();