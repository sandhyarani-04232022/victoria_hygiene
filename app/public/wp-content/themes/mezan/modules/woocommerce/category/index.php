...
if( !class_exists( 'Mezan_Woo_Listing_Category' ) ) {

    class Mezan_Woo_Listing_Category {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_DIR . '/woocommerce/category/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_URI . '/woocommerce/category/';
                } else {
        ...
        function woo_template_redirect() {
            ...
            if( is_product_category() ) {
                ...
                /* Define Sorter Settings */
                    add_filter( 'mezan_woo_sorter_settings', array( $this, 'woo_sorter_settings' ) );
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'mezan_woo_category_page_default_settings', $this->settings );
        ...
        */
            function woo_load_listing() {
                ...
                if( $this->settings['product_style_template'] == 'predefined' ) {
                    $type_class_instance = 'mezan_woo_listing_type_'.$this->settings['product_style_custom_template']; // Type Class Instance
...
if( !function_exists('mezan_woo_listing_category') ) {
	function mezan_woo_listing_category() {
		return Mezan_Woo_Listing_Category::instance();
	}
}

mezan_woo_listing_category();