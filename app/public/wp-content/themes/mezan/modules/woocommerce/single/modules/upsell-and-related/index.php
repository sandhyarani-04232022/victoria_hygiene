...
if( !class_exists( 'Mezan_Shop_Single_Module_Upsell_Related' ) ) {

    class Mezan_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
...
if( !function_exists('mezan_shop_single_module_upsell_related') ) {
	function mezan_shop_single_module_upsell_related() {
		return Mezan_Shop_Single_Module_Upsell_Related::instance();
	}
}

mezan_shop_single_module_upsell_related();