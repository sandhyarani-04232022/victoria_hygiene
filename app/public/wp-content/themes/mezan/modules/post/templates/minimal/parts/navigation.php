...
<div class="entry-post-navigation <?php echo esc_attr($select_post_navigation); ?>"><?php
	...
	if( !empty( $prev_post ) ):	?>
		...
		<div class="post-prev-link"><?php
			...
			<div class="nav-title-wrap">
				<p><a href="<?php echo get_permalink( $prev_post->ID ); ?>" title="<?php echo esc_attr($prev_post->post_title); ?>"><?php esc_html_e('Previous','mezan'); ?></a></p>
				...
				<h3><a href="<?php echo get_permalink( $prev_post->ID ); ?>" title="<?php echo esc_attr($prev_post->post_title); ?>"><?php
					if( get_the_title( $prev_post->ID ) == '') {
						echo esc_html__('Previous Post', 'mezan');
					} else {
		...
		<div class="post-prev-link no-post">
			...
			<div class="nav-title-wrap">
				<span class="zmdi zmdi-long-arrow-left zmdi-hc-fw"></span>
				<h3><?php echo esc_html__('No previous story to show!', 'mezan'); ?></h3>
			</div>
		</div>
		<?php
	endif;
	...
	if( !empty( $next_post ) ):	?>
		<div class="post-next-link"><?php
			...
			<div class="nav-title-wrap">
				<p><a href="<?php echo get_permalink( $next_post->ID ); ?>" title="<?php echo esc_attr($next_post->post_title); ?>"><?php esc_html_e('Next','mezan'); ?></a></p>
				...
				<h3><a href="<?php echo get_permalink( $next_post->ID ); ?>" title="<?php echo esc_attr($next_post->post_title); ?>"><?php
					if(get_the_title( $next_post->ID ) == '') {
						echo esc_html__('Next Post', 'mezan');
					} else {
		...
		<div class="post-next-link no-post">
			...
			<div class="nav-title-wrap">
				<span class="zmdi zmdi-long-arrow-right zmdi-hc-fw"></span>
				<h3><?php echo esc_html__('No next story to show!', 'mezan'); ?></h3>
			</div>
		</div>
		<?php
	endif; ?>
