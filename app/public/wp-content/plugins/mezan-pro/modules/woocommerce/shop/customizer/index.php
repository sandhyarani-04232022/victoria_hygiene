...
if( !class_exists( 'Mezan_Pro_Listing_Customizer_Shop' ) ) {

    class Mezan_Pro_Listing_Customizer_Shop {
        ...
        function default( $option ) {
            ...
            $settings = mezan_woo_listing_shop()->woo_default_settings();
            extract($settings);
        ...
        function shop_page_default_settings( $settings ) {
            ...
            $product_style_custom_template = mezan_customizer_settings('wdt-woo-shop-page-product-style-template' );
            ...
            $product_per_page              = mezan_customizer_settings('wdt-woo-shop-page-product-per-page' );
            $settings['product_per_page']  = $product_per_page;

            $product_layout                = mezan_customizer_settings('wdt-woo-shop-page-product-layout' );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Mezan_Customize_Section(
                    ...
                    array(
                        'title'    => esc_html__('Shop Page', 'mezan-pro'),
                 ...
                 */
                    $wp_customize->add_setting(
                        MEZAN_CUSTOMISER_VAL . '[wdt-woo-shop-page-product-style-template]', array(
                            'type'              => 'option',
                        )
                    );
                    ...
                    $wp_customize->add_control(
                        new Mezan_Customize_Control(
                            $wp_customize, MEZAN_CUSTOMISER_VAL . '[wdt-woo-shop-page-product-style-template]', array(
                                'type'     => 'select',
                 ...
                 */
                    $wp_customize->add_setting(
                        MEZAN_CUSTOMISER_VAL . '[wdt-woo-shop-page-product-per-page]', array(
                            'type' => 'option',
                        )
                    );
                    ...
                    $wp_customize->add_control(
                        new Mezan_Customize_Control(
                            $wp_customize, MEZAN_CUSTOMISER_VAL . '[wdt-woo-shop-page-product-per-page]', array(
                                'type'        => 'number',
                 ...
                 */
                    $wp_customize->add_setting(
                        MEZAN_CUSTOMISER_VAL . '[wdt-woo-shop-page-product-layout]', array(
                            'type' => 'option',
                        )
                    );

                    $wp_customize->add_control( new Mezan_Customize_Control_Radio_Image(
                        $wp_customize, MEZAN_CUSTOMISER_VAL . '[wdt-woo-shop-page-product-layout]', array(
                            'type' => 'wdt-radio-image',
                            'label' => esc_html__( 'Columns', 'mezan-pro'),
                            'section' => 'woocommerce-shop-page-section',
                            'choices' => apply_filters( 'mezan_woo_shop_columns_options', array(
                                1 => array(
                                    'label' => esc_html__( 'One Column', 'mezan-pro' ),
                                    'path' => MEZAN_PRO_DIR_URL . 'modules/woocommerce/shop/customizer/images/one-column.png'
                                ),
                                2 => array(
                                    'label' => esc_html__( 'One Half Column', 'mezan-pro' ),
                                    'path' => MEZAN_PRO_DIR_URL . 'modules/woocommerce/shop/customizer/images/one-half-column.png'
                                ),
                                3 => array(
                                    'label' => esc_html__( 'One Third Column', 'mezan-pro' ),
                                    'path' => MEZAN_PRO_DIR_URL . 'modules/woocommerce/shop/customizer/images/one-third-column.png'
                                ),
                                4 => array(
                                    'label' => esc_html__( 'One Fourth Column', 'mezan-pro' ),
                                    'path' => MEZAN_PRO_DIR_URL . 'modules/woocommerce/shop/customizer/images/one-fourth-column.png'
                                )
                            ))
                        )
                    ));
...
if( !function_exists('mezan_listing_customizer_shop') ) {
	function mezan_listing_customizer_shop() {
		return Mezan_Pro_Listing_Customizer_Shop::instance();
	}
}

mezan_listing_customizer_shop();