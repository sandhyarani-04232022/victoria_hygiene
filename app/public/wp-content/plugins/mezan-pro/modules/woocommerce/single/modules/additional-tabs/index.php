...
if( !class_exists( 'Mezan_Shop_Single_Module_Additional_Tabs' ) ) {

    class Mezan_Shop_Single_Module_Additional_Tabs {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_DIR . '/woocommerce/single/modules/additional-tabs/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_URI . '/woocommerce/single/modules/additional-tabs/';
                } else {
...
if( !function_exists('mezan_shop_single_module_additional_tabs') ) {
	function mezan_shop_single_module_additional_tabs() {
        $reflection = new ReflectionClass('Mezan_Shop_Single_Module_Additional_Tabs');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Mezan_Shop_Single_Module_Additional_Tabs::instance();