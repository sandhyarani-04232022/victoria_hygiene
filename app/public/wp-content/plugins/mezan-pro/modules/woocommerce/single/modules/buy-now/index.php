...
if( !class_exists( 'Mezan_Shop_Single_Module_Buy_Now' ) ) {

    class Mezan_Shop_Single_Module_Buy_Now {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_DIR . '/woocommerce/single/modules/buy-now/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_URI . '/woocommerce/single/modules/buy-now/';
                } else {
...
if( !function_exists('mezan_shop_single_module_buy_now') ) {
	function mezan_shop_single_module_buy_now() {
        $reflection = new ReflectionClass('Mezan_Shop_Single_Module_Buy_Now');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Mezan_Shop_Single_Module_Custom_template' ) ) {
    Mezan_Shop_Single_Module_Buy_Now::instance();
}