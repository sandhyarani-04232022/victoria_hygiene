...
if( !class_exists( 'Mezan_Shop_Single_Module_Count_Down_Timer' ) ) {

    class Mezan_Shop_Single_Module_Count_Down_Timer {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_DIR . '/woocommerce/single/modules/count-down-timer/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_URI . '/woocommerce/single/modules/count-down-timer/';
                } else {
...
if( !function_exists('mezan_shop_single_module_count_down_timer') ) {
	function mezan_shop_single_module_count_down_timer() {
        $reflection = new ReflectionClass('Mezan_Shop_Single_Module_Count_Down_Timer');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Mezan_Shop_Single_Module_Custom_template' ) ) {
    Mezan_Shop_Single_Module_Count_Down_Timer::instance();
}