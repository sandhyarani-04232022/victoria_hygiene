...
class Mezan_Shop_Elementor_Single_Additional_Info_Widgets {
	...
	function __construct() {
		...
		$this->mezan_shop_load_ai_modules();
	 ...
	 * Init
	 */
	function mezan_shop_load_ai_modules() {

		require mezan_shop_single_module_additional_info()->module_dir_path() . 'elementor/utils.php';
	...
	function mezan_shop_register_widget_styles( $suffix ) {
		...
		wp_register_style( 'wdt-shop-additional-info',
			mezan_shop_single_module_additional_info()->module_dir_url() . 'assets/css/style'.$suffix.'.css',
			array()
		);
	...
	function mezan_shop_register_widget_scripts( $suffix ) {
		...
		wp_register_script( 'wdt-shop-additional-info',
			mezan_shop_single_module_additional_info()->module_dir_url() . 'assets/js/scripts'.$suffix.'.js',
			array( 'jquery' ),
			false,
			true
		);
...
Mezan_Shop_Elementor_Single_Additional_Info_Widgets::instance();