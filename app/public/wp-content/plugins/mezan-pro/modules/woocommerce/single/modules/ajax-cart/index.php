...
if( !class_exists( 'Mezan_Shop_Single_Module_Ajax_Cart' ) ) {

    class Mezan_Shop_Single_Module_Ajax_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_DIR . '/woocommerce/single/modules/ajax-cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mezan_is_file_in_theme( __FILE__ ) ) {
                    return MEZAN_MODULE_URI . '/woocommerce/single/modules/ajax-cart/';
                } else {
...
if( !function_exists('mezan_shop_single_module_ajax_cart') ) {
	function mezan_shop_single_module_ajax_cart() {
		return Mezan_Shop_Single_Module_Ajax_Cart::instance();
	}
}

mezan_shop_single_module_ajax_cart();