		...
		if( !empty( $prev_post ) ):	?>
			...
			<div class="post-prev-link"><?php
				...
				<div class="nav-title-wrap">
					<p><a href="<?php echo get_permalink( $prev_post->ID ); ?>" title="<?php echo esc_attr($prev_post->post_title); ?>"><?php esc_html_e('Previous','mezan-pro'); ?></a></p>
			...
			<div class="post-prev-link no-post">
				...
				<div class="nav-title-wrap">
					<span class="zmdi zmdi-long-arrow-left zmdi-hc-fw"></span>
					<h3><?php echo esc_html__('Not available to show!', 'mezan-pro'); ?></h3>
				</div>
			</div>
			<?php
		endif;
