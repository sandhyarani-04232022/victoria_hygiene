...
class Elementor_Post_Related_Article extends MezanElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Related Article', 'mezan-pro');
    }
    ...
    protected function render() {
        ...
        $out .= mezan_get_template_part( 'post', 'templates/post-extra/related_article', '', $template_args );
