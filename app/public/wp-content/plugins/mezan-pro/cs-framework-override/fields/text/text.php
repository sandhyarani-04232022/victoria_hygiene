...
class CSFramework_Option_text extends CSFramework_Options {
  ...
  public function output(){
    ...
    if( isset( $this->field['slugify_title'] ) ){
        echo "<br>".'<label>'.esc_html__('Menu Slug', 'mezan-pro').'</label>';
        echo '<input type="'. esc_attr($this->element_type()) .'" name="menu-slug" value="'. esc_attr($this->slugify($this->element_value())) .'"'. mezan_html_output($this->element_class()) . $this->element_attributes() .' readonly />';
    }
