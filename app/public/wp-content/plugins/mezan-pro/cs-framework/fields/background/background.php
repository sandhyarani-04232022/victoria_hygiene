...
class CSFramework_Option_background extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<input type="text" name="'. esc_attr($this->element_name( '[image]' )) .'" value="'. esc_attr($this->value['image']) .'"'. mezan_html_output($this->element_class()) . $this->element_attributes() .'/>';
