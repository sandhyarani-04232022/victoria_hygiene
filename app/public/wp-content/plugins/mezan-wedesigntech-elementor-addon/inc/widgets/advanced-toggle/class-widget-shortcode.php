...
class WeDesignTech_Widget_Shortcode_Advanced_Toggle {
	...
	function __construct() {
        ...
        $this->widget_base = wedesigntech_widget_base_advanced_toggle();
...
//new WeDesignTech_Widget_Shortcode_Advanced_Toggle();