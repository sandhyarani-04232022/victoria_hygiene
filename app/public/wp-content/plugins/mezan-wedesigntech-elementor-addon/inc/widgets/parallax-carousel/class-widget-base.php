	...
	public function create_elementor_controls($elementor_object) {
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'selectors' => array (
					'{{WRAPPER}} .wdt-parallax-carousel-container' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-parallax-carousel-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);	
		...
		$elementor_object->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-container, {{WRAPPER}} .wdt-parallax-carousel-container h4, {{WRAPPER}} .wdt-parallax-carousel-container a, {{WRAPPER}} .wdt-parallax-carousel-container h6' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				'name' => 'border',
				'selector' => '{{WRAPPER}} .wdt-parallax-carousel-container',
			)
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-parallax-carousel-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-container:hover, {{WRAPPER}} .wdt-parallax-carousel-container:hover h4, {{WRAPPER}} .wdt-parallax-carousel-container:hover a, {{WRAPPER}} .wdt-parallax-carousel-container:hover h6' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				'name' => 'border_hover',
				'selector' => '{{WRAPPER}} .wdt-parallax-carousel-container:hover',
			)
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-parallax-carousel-container:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .wdt-parallax-carousel-title h4',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-parallax-carousel-title h4' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-container h4' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-container:hover h4' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .wdt-parallax-carousel-sub-title h6',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-parallax-carousel-sub-title h6' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-container h6' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-container:hover h6' => 'color: {{VALUE}}',
				),
			)
		);
		$elementor_object->end_controls_tab();
		...
		$elementor_object->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-icon' => 'width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-icon' => 'height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-parallax-carousel-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-parallax-carousel-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);	
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-icon i' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'types' =>  array('classic', 'gradient', 'video' ),
				'selector' => '{{WRAPPER}} .wdt-parallax-carousel-icon',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-parallax-carousel-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-parallax-carousel-icon:hover i' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'types' =>  array('classic', 'gradient', 'video' ),
				'selector' => '{{WRAPPER}} .wdt-parallax-carousel-icon:hover',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-parallax-carousel-icon:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
				...
				$output .= '<div class="swiper-wrapper">';
					...
					foreach ( $settings['features_content'] as $index => $item ) :
						...
						if( $item['content_type'] == 'template' ) {
							...
							$output .= '<div class="wdt-meta-group-content" data-swiper-parallax="-500">';
								if(isset($item['list_title']) && !empty($item['list_title'])) {
									$output .= '<div class="wdt-parallax-carousel-title"><h4>' . $item['list_title'] . '</h4></div>';
								}
								if(isset($item['list_sub_title']) && !empty($item['list_sub_title'])) {
									$output .= '<div class="wdt-parallax-carousel-sub-title" data-swiper-parallax="-200"><h6>' . $item['list_sub_title'] . '</h6></div>';
								}
								if(isset($item['list_content']) && !empty($item['list_content'])) {
									$output .= '<div class="wdt-parallax-carousel-content" data-swiper-parallax="-100">' . $item['list_content'] . '</div>';
								}
							$output .= '</div>';
							...
							$output .= '<div class="wdt-parallax-carousel-info">';
								...
								if(!empty($item['list_icon']['value'])) {
									$output .= '  <div class="wdt-parallax-carousel-icon-wrapper">';
										$output .= '  <div class="wdt-parallax-carousel-icon">';
