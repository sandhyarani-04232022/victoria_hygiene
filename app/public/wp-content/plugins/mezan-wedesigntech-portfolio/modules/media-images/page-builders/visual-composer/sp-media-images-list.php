<?php
add_action( 'vc_before_init', 'wdt_sp_media_images_list_vc_map' );

function wdt_sp_media_images_list_vc_map() {

	$listing_singular_label = apply_filters( 'listing_label', 'singular' );

	vc_map( array(
		"name"     => esc_html__( 'Media - Images List','wdt-portfolio'),
		"base"     => "wdt_sp_media_images_list",
		"icon"     => "wdt_sp_media_images_list",
		...
		"params"   => array(
			...
			array(
				...
				'param_name' => 'columns',
				'value'      => array(
					esc_html__('One Column','wdt-portfolio') => 1,
					esc_html__('Two Column','wdt-portfolio') => 2,
					esc_html__('Three Column','wdt-portfolio') => 3,
					esc_html__('Four Column','wdt-portfolio') => 4,
					esc_html__('Five Column','wdt-portfolio') => 5,
					esc_html__('Six Column','wdt-portfolio') => 6
				),
			...
			array(
				'type'        => 'dropdown',
				'heading'     => esc_html__('With Space','wdt-portfolio'),
			...
			array(
				'type'             => 'textfield',
				'heading'          => esc_html__( 'Image Ids','wdt-portfolio'),
