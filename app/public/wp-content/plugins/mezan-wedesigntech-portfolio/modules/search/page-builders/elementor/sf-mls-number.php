...
class WDTPortfolioSfMlsNumber extends Widget_Base {
	...
	public function get_name() {
		return 'wdt-widget-sf-mls-number';
	}

	public function get_title() {
		return esc_html__( 'MLS Number','wdt-portfolio');
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'mls_number_default_section', array(
	...
	protected function render() {
		...
		$output     = do_shortcode('[wdt_sf_mls_number_field '.$attributes.' /]');
