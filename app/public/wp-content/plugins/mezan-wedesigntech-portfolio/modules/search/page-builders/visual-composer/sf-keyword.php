<?php
add_action( 'vc_before_init', 'wdt_sf_keyword_field_vc_map' );

function wdt_sf_keyword_field_vc_map() {

	vc_map( array(
		"name" => esc_html__( 'Keyword','wdt-portfolio'),
		"base" => "wdt_sf_keyword_field",
		"icon" => "wdt_sf_keyword_field",
