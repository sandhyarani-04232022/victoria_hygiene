...
class WDTPortfolioSpOpeningHoursStatus extends Widget_Base {
	...
	public function get_name() {
		return 'wdt-widget-sp-opening-hours-status';
	}

	public function get_title() {
		return esc_html__( 'Opening Hours - Status','wdt-portfolio');
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'opening_hours_status_default_section', array(
	...
	protected function render() {
		...
		$output = do_shortcode('[wdt_sp_opening_hours_status '.$attributes.' /]');
