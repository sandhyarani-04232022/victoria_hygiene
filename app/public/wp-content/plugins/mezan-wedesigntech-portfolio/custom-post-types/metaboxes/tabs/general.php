...
<div class="wdt-custom-box">
    ...
    <label><?php echo esc_html__('MLS Number','wdt-portfolio'); ?></label>
    <?php $wdt_mls_number = get_post_meta($list_id, 'wdt_mls_number', true); ?>
    <input name="wdt_mls_number" type="text" value="<?php echo esc_attr( $wdt_mls_number );?>" class="wdt-mls-number" style="text-transform:uppercase" />
    <input type="button" value="<?php echo esc_attr__('Generate','wdt-portfolio'); ?>" class="wdt-generate-mls-number" />
    <div class="wdt-note"><?php echo sprintf( esc_html__('Add MLS number for your %1$s here.','wdt-portfolio'), strtolower($listing_singular_label) ); ?> </div>
