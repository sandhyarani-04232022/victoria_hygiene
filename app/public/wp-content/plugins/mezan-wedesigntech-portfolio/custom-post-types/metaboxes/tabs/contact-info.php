...
<div class="wdt-custom-box">
    ...
    <label><?php echo esc_html__('Skype','wdt-portfolio'); ?></label>
    <?php $wdt_skype = get_post_meta($list_id, 'wdt_skype', true); ?>
    <input name="wdt_skype" type="text" value="<?php echo esc_attr( $wdt_skype );?>" />
    <div class="wdt-note"><?php echo sprintf( esc_html__('Add contact skype id for your %1$s here.','wdt-portfolio'), strtolower($listing_singular_label) ); ?> </div>
