<?php
add_action( 'vc_before_init', 'wdt_sp_featured_item_vc_map' );

function wdt_sp_featured_item_vc_map() {

	$listing_singular_label = apply_filters( 'listing_label', 'singular' );

	vc_map( array(
		"name" => esc_html__( 'Featured Item','wdt-portfolio'),
		"base" => "wdt_sp_featured_item",
		"icon" => "wdt_sp_featured_item",
		...
		"params" => array(
			...
			array(
				...
				'description' => sprintf( esc_html__('Provide %1$s id for which you have to display fetured item label. No need to provide ID if it is used in %1$s single page.','wdt-portfolio'), strtolower($listing_singular_label) ),
