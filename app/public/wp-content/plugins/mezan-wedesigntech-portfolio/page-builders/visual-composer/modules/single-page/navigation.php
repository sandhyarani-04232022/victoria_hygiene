<?php
add_action( 'vc_before_init', 'wdt_sp_navigation_vc_map' );

function wdt_sp_navigation_vc_map() {

	$listing_singular_label = apply_filters( 'listing_label', 'singular' );

	vc_map( array(
		"name" => esc_html__( 'MLS Number','wdt-portfolio'),
		"base" => "wdt_sp_navigation",
		"icon" => "wdt_sp_navigation",
		...
		"params" => array(
			...
			array(
				...
				'description' => sprintf( esc_html__('Provide %1$s id for which you have to display navigation. No need to provide ID if it is used in %1$s single page.','wdt-portfolio'), strtolower($listing_singular_label) ),
