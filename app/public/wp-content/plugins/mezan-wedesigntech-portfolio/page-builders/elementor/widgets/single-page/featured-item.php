...
class WDTPortfolioSpFeaturedItem extends Widget_Base {
	...
	public function get_name() {
		return 'wdt-widget-sp-featured-item';
	}

	public function get_title() {
		return esc_html__( 'Featured Item','wdt-portfolio');
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'featured_item_default_section', array(
	...
	protected function render() {
		...
		echo do_shortcode('[wdt_sp_featured_item '.$attributes.' /]');
	}
