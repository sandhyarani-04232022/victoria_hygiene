...
class Mezan_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'mezan-plus-responsive-number-control', MEZAN_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), MEZAN_PLUS_VERSION, true );
		wp_enqueue_style( 'mezan-plus-responsive-number-control',  MEZAN_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.css', null, MEZAN_PLUS_VERSION );
	}
