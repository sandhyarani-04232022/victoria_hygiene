...
class Mezan_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'mezan-plus-fontawesome-control', MEZAN_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), MEZAN_PLUS_VERSION, true );
		wp_enqueue_style( 'mezan-plus-fontawesome-control',  MEZAN_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, MEZAN_PLUS_VERSION );

		wp_enqueue_style( 'mezan-plus-fontawesome',  MEZAN_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),MEZAN_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "mezan-plus") .' '.esc_html( $this->label );
