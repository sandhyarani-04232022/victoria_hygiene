...
if( !class_exists( 'MezanPlusBreadCrumbTypo' ) ) {
    class MezanPlusBreadCrumbTypo {
        ...
        function register( $wp_customize ) {
            $wp_customize->add_section(
                new Mezan_Customize_Section(
                    ...
                    array(
                        'title'    => esc_html__('Typography', 'mezan-plus'),
                ...
                if ( ! defined( 'MEZAN_PRO_VERSION' ) ) {
                    $wp_customize->add_control(
                        new Mezan_Customize_Control_Separator(
                            $wp_customize, MEZAN_CUSTOMISER_VAL . '[mezan-plus-site-breadcrumb-typo-separator]',
                            array(
                                'type'        => 'wdt-separator',
...
MezanPlusBreadCrumbTypo::instance();