...
if( !class_exists( 'MezanPlusFooterElementor' ) ) {
    class MezanPlusFooterElementor {
        ...
        function frontend() {
            add_filter( 'mezan_print_footer_template', array( $this, 'register_footer_template' ), 10, 1 );
        }
		...
		function register_footer_template( $id ) {
            ...
            return apply_filters( 'mezan_plus_footer_content', $content );
		}
    }
}

MezanPlusFooterElementor::instance();